...
//crud layanan
Route::get("/daftarLayanan/addView", [LayananController::class, 'addView'])->name('layanan.addView')->middleware('auth');
Route::get("/detailLayanan/{id}", [LayananController::class, 'detail'])->middleware('auth');

Route::get("/detailPasien/{id}", [UserController::class, 'detail'])->middleware('auth');
Route::get("/detailStaff/{id}", [UserController::class, 'detailStaff'])->middleware('auth');
...
Route::get("/daftarStatusStaff/addView", [StatusUserController::class, 'addView'])->name('statususer.addView')->middleware('auth');
Route::post("/daftarStatusStaff/add", [StatusUserController::class, 'add'])->name('statususer.add');

Route::get("/detailPesanan/{id}", [PesananController::class, 'detail_admin'])->name('pesanan.detail')->middleware('auth');
...
//staff
Route::get("/daftarStaff/addView", [AdminController::class, 'addStaffView'])->name('staff.addView')->middleware('auth');
Route::post("/daftarStaff/add", [AdminController::class, 'addStaff']);
Route::get("/daftarStaff/updateView/{id}", [UserController::class, 'updateStaffView'])->name('staff.updateView')->middleware('auth');
Route::patch("/daftarStaff/update/{id}", [UserController::class, 'updateStaff'])->name('staff.update');

Route::get("/pesan/updateView/{id}", [PesananController::class, 'updateView'])->name('pesanan.updateView')->middleware('auth');
...
// =================================================Pasien=================================================
// home
Route::get("/home", [PasienController::class, 'home'])->name('pasien.home')->middleware('auth');
Route::get('/home/search', [PasienController::class, 'search']);
// profile
Route::get("/profile", [PasienController::class, 'profile'])->name('pasien.profile')->middleware('auth');
Route::get("/profile/editProfile", [PasienController::class, 'editProfileView'])->middleware('auth');
Route::patch("/profile/update/{id}", [PasienController::class, 'updateProfile']);

// alamat
Route::get("/profile/alamat", [AlamatController::class, 'alamat_pasien'])->name('pasien.alamat')->middleware('auth');
Route::get("/profile/alamat/addView", [AlamatController::class, 'addView'])->name('pasien.alamat.addview')->middleware('auth');
Route::get("/profile/alamat/updateView/{id}", [AlamatController::class, 'updateView'])->name('pasien.alamat.updateview')->middleware('auth');
...
Route::get("/layanan/{id}", [PasienController::class, 'detailLayanan'])->name('layanan.detail')->middleware('auth');
Route::get("/pesan/{id}", [PesananController::class, 'addView'])->name('pesanan.addView')->middleware('auth');
Route::post("/pesan/{id}", [PesananController::class, 'add'])->name('pesanan.add');
Route::get("/detailPesananPasien/{id}", [PesananController::class, 'detail_pasien'])->middleware('auth');
Route::patch("/batalPesanan/{id}", [PesananController::class, 'batalPesanan']);

//=================================================STATUS USER=============================================================================

Route::get("/statusUser", [StatusUserController::class, 'main'])->name('statususer.main')->middleware('auth');
Route::get("/statusUser/detail/{id}", [StatusUserController::class, 'detail'])->name('statususer.detail')->middleware('auth');
// Route::get("/statusUser/addView",[StatusUserController::class,'addView'])->name('statususer.addView');

Route::get("/statusUser/updateView/{id}", [StatusUserController::class, 'updateView'])->name('statususer.updateView')->middleware('auth');
...
Route::get("/daftarLayanan/updateView/{id}", [LayananController::class, 'updateView'])->name('layanan.updateView')->middleware('auth');
