        ...
        <div class="row my-4">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-5">
                <div class="p-3 card border-end-0 border-start-0 border-bottom-0 bg-inti-muda" id="">
                    <a href="{{ url('/daftarBarang/detail/'.$item->kodeBarang) }}" class="remove-underline">
                    ...
                    <button type="button" class="btn btn-primary my-2 ms-auto me-auto py-2 px-3" id="pesan-btn">Lanjut</button>
                </div>
            </div>
            @endforeach
        </div>
