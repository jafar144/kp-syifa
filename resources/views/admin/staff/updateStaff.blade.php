                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="form-group">
                                                        <input type="number" name="NIK" id="NIK" placeholder="Masukkan NIP" onkeydown="return event.keyCode !== 69" class="form-control" value="{{ old('NIK') ?? $staff->NIK }}">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- Tanggal Lahir Staff -->
                                                    <div class="form-group">
                                                        <input type="date" name="tanggal_lahir" id="tanggal_lahir" placeholder="Masukkan tanggal lahir" class="form-control" value="{{ old('tanggal_lahir') ?? $staff->tanggal_lahir }}">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr >
                                            ...
                                            <tr >
                                                ...
                                                <td>
                                                    <!-- Email Staff -->
                                                    <div class="form-group">
                                                        <input type="email" name="email" id="email" placeholder="Masukkan email" class="form-control" value="{{ old('email') ?? $staff->email }}">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr >
                                                ...
                                                <td>
                                                    <!-- Nomor Telepon Staff -->
                                                    <div class="form-group">
                                                        <input type="number" name="notelp" id="notelp" onkeydown="return event.keyCode !== 69" placeholder="Masukkan nomor telpon" class="form-control" value="{{ old('notelp') ?? $staff->notelp}}">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr >
