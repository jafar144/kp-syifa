<x-admin-layout :title="'Detail Pesanan'">
    ...
    <div class="container">
        <div class="py-5">
            ...
            <!-- Modal Alert Belum Bayar dan Belum Telah Datang-->
            <div class="modal fade" id="modalAlertBayarTelahDatang" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content shadow-tipis">
                        <div class="modal-header">
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="text-center montserrat-extra mt-3">Warning</div>
                            <div class="text-center montserrat-bold mt-4 color-abu">Gagal Menyelesaikan Pesanan! <br>Silahkan hubungi pasien untuk meng konfirmasi kedatangan tenaga medis dan upload bukti pembayaran di Menu Edit</div>
                        </div>
                        <div class="modal-footer">
            ...
            <!-- Modal Alert Telah Datang -->
            <div class="modal fade" id="modalAlertTelahDatang" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content shadow-tipis">
                        <div class="modal-header">
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="text-center montserrat-extra mt-3">Warning</div>
                            <div class="text-center montserrat-bold mt-4 color-abu">Gagal Menyelesaikan Pesanan! <br>Silahkan hubungi pasien untuk meng konfirmasi kedatangan tenaga medis!</div>
                        </div>
                        <div class="modal-footer">
            ...
            <div class="mt-5 me-5 d-flex">
                ...
                <div class="text-end d-inline ms-auto">
                    ...
                    @elseif($pesanan->status_pesanan->status == "Berlangsung")
                        ...
                        <button type="button" class="btn btn-success me-5 ms-3" id="btn-selesai" data-bs-toggle="modal" data-bs-target="#modalAlertTelahDatang">
                            Selesai
                        </button>
                        @else
                        <button type="button" class="btn btn-success me-5 ms-3" id="btn-selesai" data-bs-toggle="modal" data-bs-target="#modalAlertBayarTelahDatang">
                            Selesai
                        </button>
                        @endif
                        
                    @elseif($pesanan->status_pesanan->status == "Telah Datang")
                        <!-- Kalau status pembayaran sudah Y atau bukti_pembayaran ada-->
                        @if($pesanan->status_pembayaran == 'Y' || $pesanan->bukti_pembayaran != null)
